...
const pageDefinitions: Record<string, PageDefinition> = {
  home: {
    ...
    fields: [
      ...
      { section: "Hero Stat Card", path: "contentJson.hero.statLabel", label: "Label", type: "text" },
      { section: "Hero Stat Card", path: "contentJson.hero.statValue", label: "Stat Value", type: "text" },
      { section: "Hero Stat Card", path: "contentJson.hero.statCaption", label: "Caption", type: "text" },
      { section: "Hero Strategy Card", path: "contentJson.hero.strategyLabel", label: "Label", type: "text" },
      {
        section: "Hero Strategy Card",
        path: "contentJson.hero.strategyHeadline",
        label: "Headline",
        type: "textarea",
        rows: 2,
      },
